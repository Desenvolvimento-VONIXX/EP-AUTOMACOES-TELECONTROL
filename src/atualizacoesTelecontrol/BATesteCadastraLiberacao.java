...
public class BATesteCadastraLiberacao implements AcaoRotinaJava {
	...
	public void doAction(ContextoAcao ctx) throws Exception {
		...
		try {
			...
			e.printStackTrace();
			ctx.setMensagemRetorno("Erro ao Executar Açao Agendada - liberacao " + e);
	...
	public void addTelaLiberacao(ContextoAcao ctx, BigDecimal nuNota, BigDecimal vlrNota, BigDecimal codTipOper,
			BigDecimal cenCus) throws Exception {
